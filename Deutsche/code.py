...
class europe():
    try:
        root = "/home/ubuntu/sanctions-scripts/Deutsche/"
        ...
        try:
            ...
            for i in data.find_all("sanctionEntity"):
                ...
                if type == "person":
                    ...
                    item['comment'] = remark
                    item['sanction_list'] = {
                        "sl_authority": "Deutsche Bundesbank, Germany",
                        "sl_url": "https://www.bundesbank.de/en/service/financial-sanctions/financial-sanctions-619000",
                        "watch_list": "European Watchlists",
                        "sl_host_country": "Germany",
                        "sl_type": "Sanctions",
                        "sl_source": "Deutsche Bundesbank Sanctions List, Germany",
                        "sl_description": "The list of sanctioned individuals and entities by Deutsche Bundesbank, Germany"
                    }
                    item['list_id'] = "DEU_S10015"
