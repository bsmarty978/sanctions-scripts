...
dag_name = "bajaj-ta"
root = "/home/ubuntu/sanctions-scripts/BAJAJ-TA/"
...
def get_hash(n):
    return hashlib.sha256(((n+'Bajaj Allianz General Insurance Co. Ltd. Black Listed Agents List, India IND_E20335').lower()).encode()).hexdigest()
