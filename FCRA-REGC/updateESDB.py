...
diffrance_filename = f'{today_date}_Difference_Output_fcraonline_fc8_cancel_query.json'
output_filename = f'{today_date}_output_fcraonline_fc8_cancel_query.json'
removed_filename = f'{today_date}_RemovedData_File_fcraonline_fc8_cancel_query.json'
