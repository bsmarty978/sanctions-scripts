...
diffrance_filename = f'{today_date}_Difference_output_fcraonline_fc1a_Satewise_old.json'
output_filename = f'{today_date}_output_fcraonline_fc1a_Satewise_old.json'
removed_filename = f'{today_date}_RemovedData_File_fcraonline_fc1a_Satewise_old.json'
