...
dag_name = "sbi-849"
root = "/home/ubuntu/sanctions-scripts/SBI-849/"
...
def get_hash(n):
    return hashlib.sha256(((n+'SBI Life Insurance Co. Ltd. Black Listed Agents List, India (India Watchlist IND_E20358)').lower()).encode()).hexdigest()
...
def sourcedownloader():
    ...
    res =  requests.get("https://www.sbilife.co.in/publicnotice-blacklist")
        ...
        for i, row in df.iterrows():
            ...
            if signatory_id.isdigit():
                ...
                try:
                    ...
                    Insurance_agent_code = row[1]
                except Exception as e:
                    print(e)
                    Insurance_agent_code = ''

                try:
                    Deactivation_Date = row[3]
                except Exception as e:
                    print(e)
                    Deactivation_Date = ''
                ...
                item['name'] = name
                item['alias_name'] = alias_maker(name)
                item['country'] = ['India']
                ...
                item['sanction_details']['issue_date'] = Deactivation_Date
                item['sanction_details']['agent_id'] = Insurance_agent_code
                item['comment'] = ""
                item['documents'] = {}
                item['sanction_list'] = {}
                item['sanction_list']['sl_authority'] = "SBI Life Insurance Co. Ltd. Black Listed Agents List, India"
                item['sanction_list']['sl_url'] = "https://www.sbilife.co.in/publicnotice-blacklist"
                item['sanction_list']['sl_host_country'] = "India"
                item['sanction_list']['sl_type'] = "Sanctions"
                item['sanction_list']['sl_source'] = "SBI Life Insurance Co. Ltd. Black Listed Agents List, India"
                item['sanction_list']['sl_description'] = "List Of black listed agent by SBI Life Insurance Co. Ltd., India"
                item['sanction_list']['watch_list'] = "India Watchlists"
                item['sanction_list']['list_id'] = "IND_E20358"
