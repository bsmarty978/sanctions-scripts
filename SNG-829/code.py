...
dag_name = "sng-829"
root = "/home/ubuntu/sanctions-scripts/SNG-829/"
...
def get_hash(n):
    return hashlib.sha256(((n+"Export Credit Guarantee Corporation of India Ltd. Black Listed Agents List, India" + "IND_E20338").lower()).encode()).hexdigest()
...
def sourcedownloader():
    ...
    r =  requests.get("https://life.futuregenerali.in/agents/terminated-agents",headers=header)
    ...
    for d in tb:
        for i,r in d.df.iterrows():
            ...
            if name.lower() == "name":
                continue
            issue_date = r[2]
            termination_date= r[3]
            appointment = r[0].strip()
            ...
            data_dict['sanction_details'] = {'issue_date':issue_date, 'termination_date':termination_date}
            data_dict['individual_details'] = {}
            data_dict['country']=['India']
            data_dict['address'] = [{'complete_addrss':'','country':'India'}]
            data_dict['documents'] = {'agent_code':appointment}
            data_dict['comment'] = ''
            data_dict["sanction_list"]= {
                        "sl_authority": "Export Credit Guarantee Corporation of India Ltd., India",
                        "sl_url": "https://life.futuregenerali.in/agents/terminated-agents",
                        "sl_host_country": "India",
                        "sl_type": "Sanctions",
                        "watch_list": "India Watchlists",
                        "sl_source": "Export Credit Guarantee Corporation of India Ltd. Black Listed Agents List, India",
                        "sl_description": "List of blacklisted agents by Export Credit Guarantee Corporation of India Ltd.",
                        "list_id": "IND_E20338"
                    }
