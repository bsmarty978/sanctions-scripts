...
def get_hash(n):
    return hashlib.sha256(((n+"Export Credit Guarantee Corporation of India Ltd. Black Listed Agents List, India(India Watchlists	IND_E20338)").lower()).encode()).hexdigest()
