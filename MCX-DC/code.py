...
dag_name = "mcx-dc"
root = "/home/ubuntu/sanctions-scripts/MCX-DC/"
...
def get_hash(n):
    return hashlib.sha256(((n+'MCX Defaulting Clients, India IND_E20317').lower()).encode()).hexdigest()
...
def sourcedownloader():
    ...
    r =  requests.get("https://www.mcxindia.com/Investor-Services/grievances/client-awareness/defaulting-clients")
    resp = HtmlResponse("example.com",body=r.text,encoding='utf-8')
    url = "https://www.mcxindia.com/"+resp.xpath("//div[@class='ir-result']/a/@href").get()
...
def process_data():
    ...
    df = pd.read_excel(f'{ip_path}/{input_filename}',header=2,sheet_name='MCX')
    ...
    for i,row in df.iterrows():
        d = {
            ...
            "sanction_list": {
                ...
                "sl_url": "https://www.mcxindia.com/Investor-Services/grievances/client-awareness/defaulting-clients", 
                "watch_list": "India Watchlists", 
                "sl_host_country": "India", 
                "sl_type": "Sanctions", 
                "sl_source": "MCX Defaulting Clients, India", 
                "sl_description": "List of the Defaulting clients by Multi Commodity Exchange of India Ltd, India",
                "list_id": "IND_E20317"
            }
        }
