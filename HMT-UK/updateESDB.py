...
output_filename = f'{today_date}_output_uk.json'
diffrance_filename =f'{today_date}_diffrance_uk.json'
removed_filename =f'{today_date}_removed_uk.json'
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("----------NEW & Update-----------------------")
        print(f"Total Available to be pushed: {len(file_data)}")
