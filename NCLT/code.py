...
dag_name = "nclt"
root = "/home/ubuntu/sanctions-scripts/NCLT/"
...
def get_hash(n):
    return hashlib.sha256(((n+"NCLT Insolvency and Bankruptcy Board of India Insolvency List, India IND_E20329").lower()).encode()).hexdigest()
...
def process_data():
    ...
    while True:
        ...
        for div in divs:
            try:
                title = div.xpath('./td[2]/a/text()').extract_first(default="").strip()
            except:
                title = ""
                continue
            try:
            ...
            item = {
                ...
                "comment": "",
                "sanction_list": {
                    "sl_authority": "Insolvency and Bankruptcy Board of India",
                    "sl_url": "https://www.ibbi.gov.in/orders/nclt",
                    "watch_list": "India Watchlists",
                    "sl_host_country": "India",
                    "sl_type": "Sanctions",
                    "sl_source": "NCLT Insolvency and Bankruptcy Board of India Insolvency List, India",
                    "list_id" : "IND_E20329",
                    "sl_description": "list of entities in National Company Law Tribunal",}
            }
            out_list.append(item)
        cond = response.xpath("//li[@class='next']/a/@href").get()
        if cond:
            p+=1
        else:
            break
