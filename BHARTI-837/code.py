...
dag_name = "bharti-837"
root = "/home/ubuntu/sanctions-scripts/BHARTI-837/"
...
def get_hash(n):
    return hashlib.sha256(((n+"Bharti AXA Life Insurance Co. Ltd. Black Listed Agents List, India").lower()).encode()).hexdigest()
...
def sourcedownloader():
    ...
    with sync_playwright() as p:
        ...
        url = "https://www.bhartiaxa.com/sites/default/files"
        page.goto(url)
        print(page.title())
        resp = HtmlResponse("example.com",body=page.content(),encoding='utf-8')
        url = resp.xpath("//a[text()='Blacklisted Advisors']/@href").get()
        # print(url)
        # exit()
    ...
    for d in tb:
        for i,r in d.df.iterrows():
            ...
            data_dict["sanction_list"]= {
                "sl_authority": "Bharti AXA Life Insurance Co. Ltd. Black Listed Agents List, India",
                "sl_url": "https://www.bhartiaxa.com/",
                "sl_host_country": "India",
                "sl_type": "Sanctions",
                "sl_source": "Bharti AXA Life Insurance Co. Ltd. Black Listed Agents List, India",
                "sl_description": "Bharti AXA Life Insurance Co. Ltd. Black Listed Agents List, India",
