...
dag_name = "excide-840"
root = "/home/ubuntu/sanctions-scripts/EXCIDE-840/"
...
def get_hash(n):
    return hashlib.sha256(((n+"Exide Life Insurance Co. Ltd. Black Listed Agents List, India (India Watchlists	IND_E20349)").lower()).encode()).hexdigest()
...
def sourcedownloader():
    ...
    r =  requests.get("https://www.exidelife.in/about-us/public-disclosures/list-of-all-disclosures")
    resp = HtmlResponse("example.com",body=r.text,encoding='utf-8')
    url = resp.xpath("//ol[@id='documentlist']/li/a[text()='Terminated Agent List']/@href").get()
    # print(url)
    # exit()
    ...
    for i in tb:
        for j, r in i.df.iterrows():
            ...
            data_dict["sanction_list"]= {
                "sl_authority": "Exide Life Insurance Co. Ltd. Black Listed Agents List, India",
                "sl_url": "https://www.exidelife.in/about-us/public-disclosures/list-of-all-disclosures",
                "sl_host_country": "India",
                "sl_type": "Sanctions",
                "sl_source": "Exide Life Insurance Co. Ltd. Black Listed Agents List, India",
                "sl_description": "List of Black Listed Agents by Exide Life Insurance Co. Ltd., India",
