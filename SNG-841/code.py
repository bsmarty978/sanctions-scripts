...
dag_name = "sng-841"
root = "/home/ubuntu/sanctions-scripts/SNG-841/"
...
def get_hash(n):
    return hashlib.sha256(((n+"Future Generali India Life Insurance Co. Ltd. Black Listed Agents List, Indiapython").lower()).encode()).hexdigest()
...
def process_data():
    ...
    for d in tb:
        for i,r in d.df.iterrows():
            ...
            "sl_authority": "Future Generali India Life Insurance Co. Ltd. Black Listed Agents List, India",
            "sl_url": "https://life.futuregenerali.in/agents/terminated-agents",
            "sl_host_country": "India",
            "sl_type": "Sanctions",
            "sl_source": "Future Generali India Life Insurance Co. Ltd. Black Listed Agents List, India",
            "sl_description": "Future Generali India Life Insurance Co. Ltd. Black Listed Agents List, India",
