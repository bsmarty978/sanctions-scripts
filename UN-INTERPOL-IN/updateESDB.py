...
diffrance_filename = f'{today_date}_Difference_Output_UN.json'
output_filename = f'{today_date}_output_UN_Individual.json'
removed_filename = f'{today_date}_RemovedData_File_UN.json'
