...
class europe():
    try:
        root = "/home/ubuntu/sanctions-scripts/EU/"
        ...
        try:
            ...
            for i in data.find_all("sanctionEntity"):
                ...
                if type == "person":
                    ...
                    item['comment'] = remark
                    item['sanction_list'] = {}
                    item['sanction_list']['sl_authority'] = "European Commission, Directorate-General for Communication, European Union"
                    item['sanction_list']['sl_url'] = "https://webgate.ec.europa.eu/fsd/fsf/"
                    item['sanction_list']['sl_host_country'] = "European Union"
                    item['sanction_list']['sl_type'] = "Sanctions"
                    item['sanction_list']['sl_source'] = "European Union Consolidated Sanctions List"
                    item['sanction_list']['sl_description'] = "The Consolidated list of sanctions subjects imposed by European Commission, Directorate-General for Communication, European Union."
                    item['sanction_list']['watch_list'] = "European Watchlists"
                    item['list_id'] = "EU_S10007"
