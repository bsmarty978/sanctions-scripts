...
dag_name = "MEXICO-776"
root = "/home/ubuntu/sanctions-scripts/MEXICO-776/"
...
def get_hash(n):
    return hashlib.sha256(((n+"Secretariat of the Civil Service (Secretaría de la Función Pública) Sanctions List, Mexico MEX_S10052").lower()).encode()).hexdigest()    
...
def process_data():
    global total_profile_available,out_list,last_updated_string

    url = "https://directoriosancionados.funcionpublica.gob.mx/SanFicTec/jsp/Ficha_Tecnica/SancionadosN.jsp"
    pay = {
        "cmdsan": "ALL",
        "tipoqry": "ALL",
        "mostrar_msg": "SI"
    ...
    name_list = resp.xpath("//form[@name='detalle']/table//tr//a/strong/text()").getall()
    name_list = list(set(name_list))
    for i in name_list:
        print(i)
        name  = langtranslation(i)
        ali = []
        if name!=i:
            ali.append(i)
        pass_dict = {
