...
input_filename  = f'un-xml-{today_date}.xml'
...
old_output_filename = f'un-json-{yesterday}.json'
...
def alin_gen(nmstr):
    ...
    if len(nm)==2:
        ...
        out.append(nm[2].strip() + " " + nm[0].strip()+ " " + nm[1].strip())
    return out
...
def fileprocessor():
    ...
    for entry in entries:
        ...
        out_obj["sanction_list"] = {
            ...
            "sl_url": "https://www.cssf.lu/en/international-financial-sanctions/",
