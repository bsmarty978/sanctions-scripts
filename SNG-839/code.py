...
dag_name = "sng-839"
root = "/home/ubuntu/sanctions-scripts/SNG-839/"
...
def get_hash(n):
    return hashlib.sha256(((n+"Edelweiss Tokio Life Insurance Co. Ltd Black Listed Agents List, India (India Watchlists IND_E20348)").lower()).encode()).hexdigest()
...
def sourcedownloader():
    ...
    res =  requests.get("https://www.edelweisstokio.in/content/dam/edelweisstokio/documents/terminated-agents/backup/2021/terminated-agents-Nov21.pdf",headers=header)
    ...
    for d in tb:
        for i,r in d.df.iterrows():
            ...
            data_dict["sanction_list"]= {
                "sl_authority": "Edelweiss Tokio Life Insurance Co. Ltd Black Listed Agents List, India",
                "sl_url": "https://www.edelweisstokio.in/sitemap-index",
                "sl_host_country": "India",
                "sl_type": "Sanctions",
                "sl_source": "Edelweiss Tokio Life Insurance Co. Ltd Black Listed Agents List, India",
                "sl_description": "Edelweiss Tokio Life Insurance Co. Ltd Black Listed Agents List, India",
