...
diffrance_filename = f'{today_date}_Difference_Output_fcraonline.json'
output_filename = f'{today_date}_output_fcraonline.json'
removed_filename = f'{today_date}_RemovedData_File_fcraonline.json'
